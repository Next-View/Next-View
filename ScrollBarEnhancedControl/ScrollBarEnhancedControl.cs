...
//Mar 2019 martin, fix scroll repeat error: move DoMouseDown call in timerMouseDownRepeater_Tick; added OnMouseCaptureChanged
//Apr 2019 martin, DrawBookmark, length 1 fix
	...
	[RefreshProperties(RefreshProperties.All)]
     public class ScrollBarEnhanced : UserControl
     {
       ...
       /// <summary>
        ...
        /// <summary>
        /// Forces repaint of ScrollBar when mouse capture changes.
        /// </summary>
        /// <param name="e"></param>
        ...
        private void DrawBookmark(Graphics graphics, ScrollBarBookmark bookmark)
        {
            ...
            if (bookmark is ValueRangeScrollBarBookmark)
            {
            	...
            	if (Maximum > Minimum){       // length fix msn 4.2019
                	bookmarkLength = (int)((( ((ValueRangeScrollBarBookmark)shapeBookmark).EndValue - shapeBookmark.Value) / (Maximum - Minimum)) * TrackLength);
            	}
